...
//   return (
//     <div className="">
//       <div className=" hidden lg:flex bg-home bg-no-repeat bg-cover h-[100vh] w-[100%]">
...
//             <Image src={LeftHomeArrow} alt="image" className="w-[60%]" />
//           </div>
//           <div className="flex flex-col items-center justify-end space-y-6 text-white text-center lg:h-[50vh]">
//             <h1 className="font-semibold text-5xl w-[70%]">
//               Let's change the world with humanity
//             </h1>
//             <p className="w-[60%] text-gray">
//               Empowering each other to lead with compassion, embrace diversity
//               and uplift every voice.
//             </p>
//             <Link
//               href="#"
//               className="flex space-x-2 justify-center bg-orange rounded-sm py-2 w-[15%] "
//             >
//               <button className=" font-semibold text-xs text-white ">
//                 Learn More
//               </button>
//               <Image src={RightArrow} alt="image" className="lg:w-[15%]" />
//             </Link>
//           </div>
//           <div className="flex space-x-[80%] justify-center pt-10">
//             <Image src={RightHomeArrow} alt="image" className="w-[60%]" />
//           </div>
//         </div>
//       </div>

//       <div className=" lg:hidden bg-phoneBack bg-no-repeat bg-cover h-[100vh] w-[100%]">
//         <div className="absolute top-0 w-full h-[100vh] bg-overlay bg-opacity-80 flex flex-col justify-center items-center">
...
//                 Learn More
//               </button>
//               <Image src={RightArrow} alt="image" className="w-[15%]" />
//             </Link>
//           </div>
//           <div className="flex space-x-[80%] justify-center pt-10">
//             <Image src={LeftHomeArrow} alt="image" className="w-[20%]" />
//             <Image src={RightHomeArrow} alt="image" className="w-[20%]" />
//           </div>
//         </div>
//       </div>

//       <div className="flex flex-wrap p-7 gap-5 lg:p-5 xl:p-10 lg:mt-20 lg:justify-between xl:space-x-5 w-[100%]">
...
//           />
//         </div>
//         <div className="flex flex-col space-y-3 lg:w-[48%] relative justify-between mt-10 lg:mt-0">
//           <button className="bg-lightOrange w-[25%] lg:w-[16%] rounded-xl text-orange font-bold py-1 absolute right-0 top-[-40px] lg:left-0 lg:top-[-30px] xl:top-[-55px] text-xs">
//             About Us
//           </button>
...
//             Testimonials
//           </p>
//           <h2 className="font-bold text-2xl lg:text-3xl lg:w-[30%]">
//             Trusted By Thousands Of People And Non-profits
//           </h2>
//         </div>

//         <Slider {...settings} className="flex justify-center lg:justify-between  items-center w-[100%]">
//           <Testimonials
//             image={Arthur}
...
import LaptopBackground1 from '../public/Images/Donate.svg';
import LaptopBackground2 from '../public/Images/HomeBack.svg';
import LaptopBackground3 from '../public/Images/RightHomeButton.svg';

import MobileBackground1 from '../public/Images/ChildEducation.svg';
import MobileBackground2 from '../public/Images/PhoneLanding.svg';
import MobileBackground3 from '../public/Images/Donate.svg';

const Home = () => {
  // Arrays to hold the imported background images for laptop and mobile
  const laptopBackgrounds = [LaptopBackground1, LaptopBackground2, LaptopBackground3];
  const mobileBackgrounds = [MobileBackground1, MobileBackground2, MobileBackground3];
  ...
  return (
    <div>
      ...
      >
        <div className="absolute top-0 w-full h-[100vh] bg-overlay bg-opacity-75 flex justify-between items-center px-10">
          ...
          <div className="flex flex-col items-center justify-end space-y-6 text-white text-center lg:h-[50vh]">
            ...
            <p className="w-[60%] text-gray">
              Empowering each other to lead with compassion, embrace diversity and uplift every voice.
            </p>
            <Link href="#" className="flex space-x-2 justify-center bg-orange rounded-sm py-2 w-[15%] ">
              <button className="font-semibold text-xs text-white">Learn More</button>
              <Image src={RightArrow} alt="right arrow" className="lg:w-[15%]" />
            </Link>
          </div>
          <div className="flex space-x-[80%] justify-center pt-10">
            <Image
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${mobileBackgrounds[currentIndex]})`,
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
      >
        <div className="absolute top-0 w-full h-[100vh] bg-overlay bg-opacity-80 flex flex-col justify-center items-center">
          <div className="flex flex-col items-center justify-end space-y-5 text-white text-center lg:h-[50vh]">
            ...
            <Link href="#" className="flex space-x-2 justify-center bg-orange rounded-sm py-2 w-[30%] ">
              <button className="font-semibold text-xs text-white">Learn More</button>
